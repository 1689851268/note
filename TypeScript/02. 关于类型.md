...
<img src="./picture/6c9585af1885bfd28ad9a3d3dde3d89.jpg" alt="6c9585af1885bfd28ad9a3d3dde3d89" style="zoom:80%;" />
...
-   `unknown` 表示未知的类型
-   `unknown` 类型的变量可以被赋值为任意值，但在对 `unknown` 类型的变量做任意操作之前 都需要确认 `unknown` 变量的准确类型
...
-   一般用于修饰没有返回值的函数（但其实 `void` 修饰的函数还可以返回 `undefined` / ``）
