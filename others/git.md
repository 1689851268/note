...
1. `git push <远程库>  [ <本地分支名>[:<远程分支名>] ]`：将本地仓库的修改推送到远程仓库
   ...
   `git push origin :<远程库分支名>`：仅省略本地分支名，表示推送一个空的本地分支到远程分支；相当于删除指定的远程分支

2. `git push origin --delete <远程分支名>`：删除指定的远程分支；会把与其关联的本地分支也删除掉

3. `git push --set-upstream origin <branch_1>`：对于新建的本地分支，首次 push 需要与远程分支建立联系
...
1. `git pull <远程库> <远程分支名>[:<本地分支名>]`：从远程库获取最新代码、合并到指定分支
   ...
   如果只有一个远程库，则 `<远程库>` 可以省略
2. `<font style="color: skyblue">`**拉取最新代码：**`</font>`
   `<远程分支名>` - 默认与本地分支同名
   `:<本地分支名>` - 默认为当前分支
...
<img src="picture/git/image-20220717122329704.png" alt="image-20220717122329704" style="zoom: 67%;" />
...
<img src="picture/git/image-20220717122955167.png" alt="image-20220717122955167" style="zoom: 67%;" />
...
<img src="picture/git/image-20220717175618778.png" alt="image-20220717175618778" style="zoom: 67%;" /><img src="picture/git/image-20220717175736395.png" alt="image-20220717175736395" style="zoom: 74%;" />
...
<img src="picture/git/image-20220717180121921.png" alt="image-20220717180121921" style="zoom: 67%;" />
