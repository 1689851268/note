...
contract Father {
    ...
    function getNumber2() public pure virtual returns (uint256) {
        return 20;
    }
}
...
contract Son is Father {
    function getNumber2() public pure override returns (uint256) {
        return 40;
    }
}
```
...
contract Father {
    ...
    function getNumber3() public pure virtual returns (uint256) {
        return 30;
    }
}
...
contract Son is Father {
    ...
    function getNumber3() public pure virtual override returns (uint256) {
        return 50;
    }
}

contract GrandSon is Son {
    function getNumber3() public pure override returns (uint256) {
        return 60;
    }
}
```
...
contract C is A, B {
    constructor(string memory _name, uint256 _number) A(_name) B(_number) {}
}
...
contract E is A("Hello"), B {
    constructor(uint256 _number) B(_number) {}
}
```
