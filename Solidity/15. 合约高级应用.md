...
contract TimeLock {
    ...
    // 最小锁定时间
    uint256 public constant MIN_DELAY = 60; // 生产环境常用 1 days ~ 2 days

    // 最大锁定时间
    uint256 public constant MAX_DELAY = 120; // 生产环境常用 7 days ~ 30 days

    // 到期执行的宽限时间
    uint256 public constant GRACE_PERIOD = 60; // 生产环境常用 1 days ~ 7 days
...
contract TestTimeLock {
    ...
    // 辅助函数, 获取测试函数的执行时间
    function getExecutedTime() public view returns (uint256) {
