        ...
        <el-container>
            ...
            <el-main>
                <el-tabs v-model="currentTab" closable @tab-remove="removeTab" type="card" @tab-click="changeTab">
                    <el-tab-pane v-for="item in allTabs" :label="item.name" :name="item.value" :key="item.value">
                    </el-tab-pane>
                </el-tabs>
    ...
    mounted() {
        if (window.__POWERED_BY_QIANKUN__) {
            ...
            this.$parentProps.onGlobalStateChange((state) => {
                ...
                const loadedRouteNames = childRoute.map((item) => this.$router.resolve(item).route.name);
                // 获取去重后的数组
