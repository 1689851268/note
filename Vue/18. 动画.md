...
1. 进入：`.v-enter-from` 始状态、`.v-enter-to` 末状态、`.v-enter-active` 进入动画（Vue3）
2. 离开：`.v-leave-from` 始状态、`.v-leave-to` 末状态、`.v-leave-active` 离开动画（Vue3）

<img src="picture/8.%20%E5%8A%A8%E7%94%BB/image-20220209222414571.png" alt="image-20220209222414571" style="zoom: 50%;" />
