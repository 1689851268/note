...
4. 把 mock 数据需要的图片放置到 public 文件夹下：创建 images 文件夹，并放入需要的图片
...
<div class="register">
    ...
    <div class="content">
        ...
        <input
            ...
            v-model="phone"
            name="phone" // name 对应配置项 attributes
            v-validate="{ required: true, regex: /^1\d{10}$/ }" // 设置必须配置 & 正则规则
            :class="{ invalid: errors.has('phone') }" // 设置错误提示
        />
    ...
    <div class="content">
        ...
        <input
            ...
            name="checkPassword"
            v-validate="{ required: true, is: password }" // 通过 is 设置正则规则，表示与 XXX 一样
    ...
    <div class="controls">
        <input
            ...
            @change="agree = !agree"
            name="isCheck"
            v-validate="{ required: true, agreement: true }" // 这里应用自定义正则检验
