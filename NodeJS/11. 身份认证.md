...
优点：① 信息都存储在浏览器，可以减轻服务器负担；② 因为伪造的请求没有携带有效的 token，所以可以有效防止 CSRF （Cross-site request forgery，跨站点请求伪造）；③ 非常适合移动端应用 (因为移动端应用对 cookie 的支持不太友好)
...
![image-20230924211539363](./picture/image-20230924211539363.png)

<br>

## 服务端配置 JWT

![image-20230924211657985](./picture/image-20230924211657985.png)
